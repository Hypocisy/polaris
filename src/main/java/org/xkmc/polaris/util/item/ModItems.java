...
public class ModItems {
        ...
        public static final RegistryObject<Item> StarCoin1 = Registration.ITEMS.register("star_coin_1",
                        () -> new Item(new Item.Properties().tab(ModItemGroup.TAB_POLARIS_MISCELLANEOUS)));
        // II 星币
        ...
        public static final RegistryObject<ArmorItem> StardustHelmet = Registration.ITEMS.register("stardust_helmet",
                () -> new ArmorItem(ModArmorMaterial.STARDUST, EquipmentSlotType.HEAD, new Item.Properties().tab(ModItemGroup.TAB_POLARIS_ARMORS)));
        // 星界之尘胸甲
        public static final RegistryObject<ArmorItem> StardustChest = Registration.ITEMS.register("stardust_chestplate",
                () -> new ArmorItem(ModArmorMaterial.STARDUST, EquipmentSlotType.CHEST, new Item.Properties().tab(ModItemGroup.TAB_POLARIS_ARMORS)));
        // 星界之尘护腿
        public static final RegistryObject<ArmorItem> StardustLeggings = Registration.ITEMS.register("stardust_leggings",
                () -> new ArmorItem(ModArmorMaterial.STARDUST, EquipmentSlotType.LEGS, new Item.Properties().tab(ModItemGroup.TAB_POLARIS_ARMORS)));
        // 星界之尘靴子
        public static final RegistryObject<ArmorItem> StardustBoots = Registration.ITEMS.register("stardust_boots",
                () -> new ArmorItem(ModArmorMaterial.STARDUST, EquipmentSlotType.FEET, new Item.Properties().tab(ModItemGroup.TAB_POLARIS_ARMORS)));

        // 星界之辉套
        // 星界之辉头盔
        public static final RegistryObject<ArmorItem> StarburstHelmet = Registration.ITEMS.register("starburst_helmet",
                () -> new ArmorItem(ModArmorMaterial.STARBURST, EquipmentSlotType.HEAD, new Item.Properties().tab(ModItemGroup.TAB_POLARIS_ARMORS)));
        // 星界之辉胸甲
        public static final RegistryObject<ArmorItem> StarburstChest = Registration.ITEMS.register("starburst_chestplate",
                () -> new ArmorItem(ModArmorMaterial.STARBURST, EquipmentSlotType.CHEST, new Item.Properties().tab(ModItemGroup.TAB_POLARIS_ARMORS)));
        // 星界之辉护腿
        public static final RegistryObject<ArmorItem> StarburstLeggings = Registration.ITEMS.register("starburst_leggings",
                () -> new ArmorItem(ModArmorMaterial.STARBURST, EquipmentSlotType.LEGS, new Item.Properties().tab(ModItemGroup.TAB_POLARIS_ARMORS)));
        // 星界之辉靴子
        public static final RegistryObject<ArmorItem> StarburstBoots = Registration.ITEMS.register("starburst_boots",
                () -> new ArmorItem(ModArmorMaterial.STARBURST, EquipmentSlotType.FEET, new Item.Properties().tab(ModItemGroup.TAB_POLARIS_ARMORS)));

        // 星界之主
        // 星界之主头盔
        public static final RegistryObject<ArmorItem> StarLordHelmet = Registration.ITEMS.register("star_lord_helmet",
                () -> new ArmorItem(ModArmorMaterial.STAR_LORD, EquipmentSlotType.HEAD, new Item.Properties().tab(ModItemGroup.TAB_POLARIS_ARMORS)));
        // 星界之主胸甲
        public static final RegistryObject<ArmorItem> StarLordChest = Registration.ITEMS.register("star_lord_chestplate",
                () -> new ArmorItem(ModArmorMaterial.STAR_LORD, EquipmentSlotType.CHEST, new Item.Properties().tab(ModItemGroup.TAB_POLARIS_ARMORS)));
        // 星界之主护腿
        public static final RegistryObject<ArmorItem> StarLordLeggings = Registration.ITEMS.register("star_lord_leggings",
                () -> new ArmorItem(ModArmorMaterial.STAR_LORD, EquipmentSlotType.LEGS, new Item.Properties().tab(ModItemGroup.TAB_POLARIS_ARMORS)));
        // 星界之主靴子
        public static final RegistryObject<ArmorItem> StarLordBoots = Registration.ITEMS.register("star_lord_boots",
                () -> new ArmorItem(ModArmorMaterial.STAR_LORD, EquipmentSlotType.FEET, new Item.Properties().tab(ModItemGroup.TAB_POLARIS_ARMORS)));

        // 玄灵系列
        // 玄灵头盔
        public static final RegistryObject<ArmorItem> MSBaseHelmet = Registration.ITEMS.register("ms_base_helmet",
                () -> new ArmorItem(ModArmorMaterial.MSBase, EquipmentSlotType.HEAD, new Item.Properties().tab(ModItemGroup.TAB_POLARIS_ARMORS)));
        // 玄灵胸甲
        public static final RegistryObject<ArmorItem> MSBaseChest = Registration.ITEMS.register("ms_base_chestplate",
                () -> new ArmorItem(ModArmorMaterial.MSBase, EquipmentSlotType.CHEST, new Item.Properties().tab(ModItemGroup.TAB_POLARIS_ARMORS)));
        // 玄灵护腿
        public static final RegistryObject<ArmorItem> MSBaseLeggings = Registration.ITEMS.register("ms_base_leggings",
                () -> new ArmorItem(ModArmorMaterial.MSBase, EquipmentSlotType.LEGS, new Item.Properties().tab(ModItemGroup.TAB_POLARIS_ARMORS)));
        // 玄灵靴子
        public static final RegistryObject<ArmorItem> MSBaseBoots = Registration.ITEMS.register("ms_base_boots",
                () -> new ArmorItem(ModArmorMaterial.MSBase, EquipmentSlotType.FEET, new Item.Properties().tab(ModItemGroup.TAB_POLARIS_ARMORS)));

        // 玄灵白虎
        // 玄灵白虎头盔
        public static final RegistryObject<ArmorItem> MSWhiteTigerHelmet = Registration.ITEMS.register("ms_white_tiger_helmet",
                () -> new ArmorItem(ModArmorMaterial.MSWhiteTiger, EquipmentSlotType.HEAD, new Item.Properties().tab(ModItemGroup.TAB_POLARIS_ARMORS)));
        // 玄灵白虎胸甲
        public static final RegistryObject<ArmorItem> MSWhiteTigerChest = Registration.ITEMS.register("ms_white_tiger_chestplate",
                () -> new ArmorItem(ModArmorMaterial.MSWhiteTiger, EquipmentSlotType.CHEST, new Item.Properties().tab(ModItemGroup.TAB_POLARIS_ARMORS)));
        // 玄灵白虎灵护腿
        public static final RegistryObject<ArmorItem> MSWhiteTigerLeggings = Registration.ITEMS.register("ms_white_tiger_leggings",
                () -> new ArmorItem(ModArmorMaterial.MSWhiteTiger, EquipmentSlotType.LEGS, new Item.Properties().tab(ModItemGroup.TAB_POLARIS_ARMORS)));
        // 玄灵白虎靴子
        public static final RegistryObject<ArmorItem> MSWhiteTigerBoots = Registration.ITEMS.register("ms_white_tiger_boots",
                () -> new ArmorItem(ModArmorMaterial.MSWhiteTiger, EquipmentSlotType.FEET, new Item.Properties().tab(ModItemGroup.TAB_POLARIS_ARMORS)));

        // 玄灵青龙
        // 玄灵青龙头盔
        public static final RegistryObject<ArmorItem> MSBlueDragonHelmet = Registration.ITEMS.register("ms_blue_dragon_helmet",
                () -> new ArmorItem(ModArmorMaterial.MSBlueDragon, EquipmentSlotType.HEAD, new Item.Properties().tab(ModItemGroup.TAB_POLARIS_ARMORS)));
        // 玄灵青龙胸甲
        public static final RegistryObject<ArmorItem> MSBlueDragonChest = Registration.ITEMS.register("ms_blue_dragon_chestplate",
                () -> new ArmorItem(ModArmorMaterial.MSBlueDragon, EquipmentSlotType.CHEST, new Item.Properties().tab(ModItemGroup.TAB_POLARIS_ARMORS)));
        // 玄灵青龙护腿
        public static final RegistryObject<ArmorItem> MSBlueDragonLeggings = Registration.ITEMS.register("ms_blue_dragon_leggings",
                () -> new ArmorItem(ModArmorMaterial.MSBlueDragon, EquipmentSlotType.LEGS, new Item.Properties().tab(ModItemGroup.TAB_POLARIS_ARMORS)));
        // 玄灵青龙靴子
        public static final RegistryObject<ArmorItem> MSBlueDragonBoots = Registration.ITEMS.register("ms_blue_dragon_boots",
                () -> new ArmorItem(ModArmorMaterial.MSBlueDragon, EquipmentSlotType.FEET, new Item.Properties().tab(ModItemGroup.TAB_POLARIS_ARMORS)));

        // 玄灵朱雀
        // 玄灵朱雀头盔
        public static final RegistryObject<ArmorItem> MSVermilionBirdHelmet = Registration.ITEMS.register("ms_vermilion_bird_helmet",
                () -> new ArmorItem(ModArmorMaterial.MSVermilionBird, EquipmentSlotType.HEAD, new Item.Properties().tab(ModItemGroup.TAB_POLARIS_ARMORS)));
        // 玄灵朱雀胸甲
        public static final RegistryObject<ArmorItem> MSVermilionBirdChest = Registration.ITEMS.register("ms_vermilion_bird_chestplate",
                () -> new ArmorItem(ModArmorMaterial.MSVermilionBird, EquipmentSlotType.CHEST, new Item.Properties().tab(ModItemGroup.TAB_POLARIS_ARMORS)));
        // 玄灵朱雀护腿
        public static final RegistryObject<ArmorItem> MSVermilionBirdLeggings = Registration.ITEMS.register("ms_vermilion_bird_leggings",
                () -> new ArmorItem(ModArmorMaterial.MSVermilionBird, EquipmentSlotType.LEGS, new Item.Properties().tab(ModItemGroup.TAB_POLARIS_ARMORS)));
        // 玄灵朱雀靴子
        public static final RegistryObject<ArmorItem> MSVermilionBirdBoots = Registration.ITEMS.register("ms_vermilion_bird_boots",
                () -> new ArmorItem(ModArmorMaterial.MSVermilionBird, EquipmentSlotType.FEET, new Item.Properties().tab(ModItemGroup.TAB_POLARIS_ARMORS)));

        // 玄灵玄武
        // 玄灵玄武头盔
        public static final RegistryObject<ArmorItem> MSBlackTortoiseHelmet = Registration.ITEMS.register("ms_black_tortoise_helmet",
                () -> new ArmorItem(ModArmorMaterial.MSBlackTortoise, EquipmentSlotType.HEAD, new Item.Properties().tab(ModItemGroup.TAB_POLARIS_ARMORS)));
        // 玄灵玄武胸甲
        public static final RegistryObject<ArmorItem> MSBlackTortoiseChest = Registration.ITEMS.register("ms_black_tortoise_chestplate",
                () -> new ArmorItem(ModArmorMaterial.MSBlackTortoise, EquipmentSlotType.CHEST, new Item.Properties().tab(ModItemGroup.TAB_POLARIS_ARMORS)));
        // 玄灵玄武护腿
        public static final RegistryObject<ArmorItem> MSBlackTortoiseLeggings = Registration.ITEMS.register("ms_black_tortoise_leggings",
                () -> new ArmorItem(ModArmorMaterial.MSBlackTortoise, EquipmentSlotType.LEGS, new Item.Properties().tab(ModItemGroup.TAB_POLARIS_ARMORS)));
        // 玄灵玄武靴子
        public static final RegistryObject<ArmorItem> MSBlackTortoiseBoots = Registration.ITEMS.register("ms_black_tortoise_boots",
                () -> new ArmorItem(ModArmorMaterial.MSBlackTortoise, EquipmentSlotType.FEET, new Item.Properties().tab(ModItemGroup.TAB_POLARIS_ARMORS)));

        // 至高创世
        // 至高创世头盔
        public static final RegistryObject<ArmorItem> SupremeGenesisHelmet = Registration.ITEMS.register("supreme_genesis_helmet",
                () -> new ArmorItem(ModArmorMaterial.SupremeGenesis, EquipmentSlotType.HEAD, new Item.Properties().tab(ModItemGroup.TAB_POLARIS_ARMORS)));
        // 至高创世胸甲
        public static final RegistryObject<ArmorItem> SupremeGenesisChest = Registration.ITEMS.register("supreme_genesis_chestplate",
                () -> new ArmorItem(ModArmorMaterial.SupremeGenesis, EquipmentSlotType.CHEST, new Item.Properties().tab(ModItemGroup.TAB_POLARIS_ARMORS)));
        // 至高创世护腿
        public static final RegistryObject<ArmorItem> SupremeGenesisLeggings = Registration.ITEMS.register("supreme_genesis_leggings",
                () -> new ArmorItem(ModArmorMaterial.SupremeGenesis, EquipmentSlotType.LEGS, new Item.Properties().tab(ModItemGroup.TAB_POLARIS_ARMORS)));
        // 至高创世靴子
        public static final RegistryObject<ArmorItem> SupremeGenesisBoots = Registration.ITEMS.register("supreme_genesis_boots",
                () -> new ArmorItem(ModArmorMaterial.SupremeGenesis, EquipmentSlotType.FEET, new Item.Properties().tab(ModItemGroup.TAB_POLARIS_ARMORS)));
        ...
        public static final RegistryObject<ArmorItem> EmperorsNewClothesHelmet = Registration.ITEMS.register("emperors_new_clothes_helmet",
                () -> new ArmorItem(ModArmorMaterial.EmperorsNewClothes, EquipmentSlotType.HEAD, new Item.Properties().tab(ModItemGroup.TAB_POLARIS_ARMORS)));
        // 帝王新衣胸甲
        public static final RegistryObject<ArmorItem> EmperorsNewClothesChest = Registration.ITEMS.register("emperors_new_clothes_chestplate",
                () -> new ArmorItem(ModArmorMaterial.EmperorsNewClothes, EquipmentSlotType.CHEST, new Item.Properties().tab(ModItemGroup.TAB_POLARIS_ARMORS)));
        // 帝王新衣护腿
        public static final RegistryObject<ArmorItem> EmperorsNewClothesLeggings = Registration.ITEMS.register("emperors_new_clothes_leggings",
                () -> new ArmorItem(ModArmorMaterial.EmperorsNewClothes, EquipmentSlotType.LEGS, new Item.Properties().tab(ModItemGroup.TAB_POLARIS_ARMORS)));
        // 帝王新衣靴子
        public static final RegistryObject<ArmorItem> EmperorsNewClothesBoots = Registration.ITEMS.register("emperors_new_clothes_boots",
                () -> new ArmorItem(ModArmorMaterial.EmperorsNewClothes, EquipmentSlotType.FEET, new Item.Properties().tab(ModItemGroup.TAB_POLARIS_ARMORS)));

        // 猫猫Color1
        // 猫猫头盔
        public static final RegistryObject<ArmorItem> LittleCatHelmet = Registration.ITEMS.register("little_cat_helmet",
                () -> new ArmorItem(ModArmorMaterial.LittleCat, EquipmentSlotType.HEAD, new Item.Properties().tab(ModItemGroup.TAB_POLARIS_ARMORS)));
        // 猫猫胸甲
        public static final RegistryObject<ArmorItem> LittleCatChest = Registration.ITEMS.register("little_cat_chestplate",
                () -> new ArmorItem(ModArmorMaterial.LittleCat, EquipmentSlotType.CHEST, new Item.Properties().tab(ModItemGroup.TAB_POLARIS_ARMORS)));
        // 猫猫护腿
        public static final RegistryObject<ArmorItem> LittleCatLeggings = Registration.ITEMS.register("little_cat_leggings",
                () -> new ArmorItem(ModArmorMaterial.LittleCat, EquipmentSlotType.LEGS, new Item.Properties().tab(ModItemGroup.TAB_POLARIS_ARMORS)));
        // 猫猫靴子
        public static final RegistryObject<ArmorItem> LittleCatBoots = Registration.ITEMS.register("little_cat_boots",
                () -> new ArmorItem(ModArmorMaterial.LittleCat, EquipmentSlotType.FEET, new Item.Properties().tab(ModItemGroup.TAB_POLARIS_ARMORS)));
